...
public class HashedWheelTimer implements Timer {
    ...
    public HashedWheelTimer(
        ...
        // Prevent overflow.  校验是否存在溢出。即指针转动的时间间隔不能太长而导致tickDuration*wheel.length>Long.MAX_VALUE
    ...
    private static int normalizeTicksPerWheel(int ticksPerWheel) {
        ...
        *     // n = 0000 0000 0000 0000 0000 0000 0000 0110   
              	  ...
              	  =	 0000 0000 0000 0000 0000 0000 0000 0111 4+2+1 = 7
        * 	
        * 
        *   // 这里参考java8 hashmap的算法，使推算的过程固定
    			int n = ticksPerWheel - 1; //此操作为了处理cap=2^2的情况，如果不减1，计算的结果位2的n+1方，实际应该是 cap = 2^n的时候计算结果为2^n
    			n |= n >>> 1;
    			n |= n >>> 2;
    			n |= n >>> 4;
    			n |= n >>> 8;
    ...
    private final class Worker implements Runnable {
        ...
        @Override
        public void run() {
            // Initialize the startTime.   System.nanoTime 纳秒级 不能用于计算当前时间， 只用于求时间差，可能返回负值   
        ...
        private long waitForNextTick() {
            ...
            for (;;) {
                ...
                // 而2ms其实是未到达deadline这个时间点的，所有为了使上述情况能sleep足够的时间，加上999999后，会多睡1ms 确保到期
