...
public class TimingWheel2<E> {  
     ...
     * @param timeUnit 
     */  
    public TimingWheel2(int tickDuration, int ticksPerWheel, TimeUnit timeUnit) {  
        if (timeUnit == null) {  
    ...
    /** 
     * Add a element to {@link TimingWheel2} and start to count down its life-time. 
     *  
     * @param e 
